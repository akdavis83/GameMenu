...
window.requestAnimFrame = (function(){
  ...
  function checkEndGame() {
      if (Math.abs(player.x - endGameLocation.x) < 64 && Math.abs(player.y - endGameLocation.y) < 64) {
          window.location.href = "index11.html"; // Redirect to next page
      }
  }
  
  // Create player
  var player = new ent();
  player.sprite("https://opengameart.org/sites/default/files/lpcmalegoldenarmorpreview.png", 0, 640, 64, 64, 100, 100, 62, 62, 25);
  ...
  function createEnemy(x, y, health) {
    ...
    var enemyTypes = [
        ...
        "../custom1/Wolf.png",
        "../custom1/ice_ant.png",
        "../custom1/monster/demons/ice_devil.png",
        "../custom1/monster/demons/ice_fiend.png",
        "../custom1/monster/demons/blizzard_demon.png",
        "../custom1/monster/nonliving/crystal_golem.png",
        "../custom1/monster/nonliving/crystal_guardian.png",
        "../custom1/monster/nonliving/orb_of_ice.png",
        "../custom1/monster/nonliving/orb_of_ice.png",
        "../custom1/monster/dragons/ice_dragon_new.png",
        "../custom1/monster/dragons/quicksilver_dragon_new.png",
        "../custom1/monster/animals/ice_beast.png",
    ...
    enemy.sprite(randomType, 0, 0, 120, 120, x, y, 192, 192, 50);
    enemy.load = true;
    enemy.health = 500000000;
    enemies.push(enemy);
  }
      ...
      enemies.forEach(function(enemy, index) {
          if (Math.abs(player.x - enemy.x) > 500 && Math.abs(player.y - enemy.y) > 500) {
              ...
              if (enemy.health <= 0) {
                  ...
                  playerHealth = Math.min(playerHealth += 20000000, 10000000000000000000000000000000000000);  // Reward player with health
                  playerStats.attack += 200000;  // Increase player attack power
              }
          }
      });
  }
  ...
  setInterval(function() {
      enemies.forEach(function(enemy) {
          enemy.health += 400000;  // Increase health
          enemy.speed += 1;  // Increase speed slightly
      });
  }, 1);
  ...
  function updateEnemyBehavior(enemy) {
      ...
      if (distance > 50) {
          ...
          playerHealth -= 100000;  // Drain player health if too close
      }
  }
      ...
      enemies.forEach(function(enemy, index) {
          if (Math.abs(player.x - enemy.x) < 500 && Math.abs(player.y - enemy.y) < 500) {
              ...
              if (enemy.health <= 0) {
                  ...
                  playerHealth = Math.min(playerHealth + 20000000, 100000000000000000000000000000000000000);
                  playerStats.attack += 200000;
