...
window.requestAnimFrame = (function(){
  ...
  function createEnemy(x, y, health) {
    ...
    enemy.sprite(randomType, 0, 0, 512, 512, x, y, 512, 512, 50);
    enemy.load = true;
  ...
  attackSprite.src = "../custom1/rotator2.png";
      ...
      enemies.forEach(function(enemy, index) {
          if (Math.abs(player.x - enemy.x) > 500 && Math.abs(player.y - enemy.y) > 500) {
              ...
              if (enemy.health <= 0) {
                  ...
                  playerHealth = Math.min(playerHealth += 30000000, 10000000000000000000000000000000000000);  // Reward player with health
                  playerStats.attack += 300000;  // Increase player attack power
              }
          }
      });
  }
  ...
  setInterval(function() {
      enemies.forEach(function(enemy) {
          enemy.health += 500000;  // Increase health
  ...
  function updateEnemyBehavior(enemy) {
      ...
      if (distance > 50) {
          ...
          playerHealth -= 300000;  // Drain player health if too close
      }
  }
      ...
      enemies.forEach(function(enemy, index) {
          if (Math.abs(player.x - enemy.x) < 500 && Math.abs(player.y - enemy.y) < 500) {
              ...
              if (enemy.health <= 0) {
                  ...
                  playerHealth = Math.min(playerHealth + 30000000, 100000000000000000000000000000000000000);
                  playerStats.attack += 300000;
