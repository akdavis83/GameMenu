// TO DO: 
// 
/// Expand on the level design-second tile image is not loading up/ 
// Add images to the landscape like trees and rocks that the player cannot walk through
// 
// 
...
window.requestAnimFrame = (function(){
  ...
  setInterval(function() {
      enemies.forEach(function(enemy) {
          ...
          enemy.speed += 10;  // Increase speed slightly
      });
  }, 1);
  ...
  function updateEnemyBehavior(enemy) {
      ...
      if (distance > 50) {
          ...
          playerHealth -= 100;  // Drain player health if too close
      }
  }
  ...
  var tiles = function() {
      ...
      this.draw = function() {
        ...
        var img = Math.random() > 0.0001 ? tileImage : tileImage2;
